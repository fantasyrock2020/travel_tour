...
mixin _$LanguageState {
 ...
 Locale get locale; Iterable<Locale> get supportedLocales;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LanguageState&&(identical(other.locale, locale) || other.locale == locale)&&const DeepCollectionEquality().equals(other.supportedLocales, supportedLocales));
}


@override
int get hashCode => Object.hash(runtimeType,locale,const DeepCollectionEquality().hash(supportedLocales));

@override
String toString() {
  return 'LanguageState(locale: $locale, supportedLocales: $supportedLocales)';
}
...
/// Create a copy of LanguageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? locale = null,Object? supportedLocales = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Locale locale,  Iterable<Locale> supportedLocales)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.locale,_that.supportedLocales);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Locale locale,  Iterable<Locale> supportedLocales)  $default,) {final _that = this;
switch (_that) {
case _LanguageState():
return $default(_that.locale,_that.supportedLocales);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Locale locale,  Iterable<Locale> supportedLocales)?  $default,) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.locale,_that.supportedLocales);case _:
  return null;
...
class _LanguageState implements LanguageState {
  const _LanguageState({required this.locale, required this.supportedLocales});
  

@override final  Locale locale;
@override final  Iterable<Locale> supportedLocales;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LanguageState&&(identical(other.locale, locale) || other.locale == locale)&&const DeepCollectionEquality().equals(other.supportedLocales, supportedLocales));
}
...
/// Create a copy of LanguageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? locale = null,Object? supportedLocales = null,}) {
