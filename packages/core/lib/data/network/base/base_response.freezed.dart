...
mixin _$BaseResponse<T> {
 ...
 String? get status; int? get totalResults; T? get data;
...
@useResult
$Res call({
 String? status, int? totalResults, T? data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? status,  int? totalResults,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BaseResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? status,  int? totalResults,  T? data)  $default,) {final _that = this;
switch (_that) {
case _BaseResponse():
return $default(_that.status,_that.totalResults,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? status,  int? totalResults,  T? data)?  $default,) {final _that = this;
switch (_that) {
case _BaseResponse() when $default != null:
return $default(_that.status,_that.totalResults,_that.data);case _:
  return null;
...
class _BaseResponse<T> extends BaseResponse<T> {
  const _BaseResponse({this.status, this.totalResults, this.data}): super._();
